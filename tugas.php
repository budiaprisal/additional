...
<body>
 ...
 <nav>
  <div class="nav nav-pills" id="nav-item" role="tablist">
    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Users List</a>
    <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">User Profile</a>
    <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Statistic</a>
...
<form class="form-inline my-2 my-lg-0">
                     <div class="input-group">
                        ...
                        <div class="input-group-append">
                           <span class="input-group-text" id="basic-addon2"><i class="material-icons" style="font-size:20px">search</i>
                        </div>
                     </div>
...
<nav class="mt-4">
      ...
      <div class="tab-content" id="nav-tabContent">
         <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
            ...
            <img src="  https://dynamic.zacdn.com/3W4L3QL8uUNGhvbKKXjYTcFMc6k=/fit-in/346x500/filters:quality(90):fill(ffffff)/http://static.id.zalora.net/p/cardinal-1445-1285661-1.jpg" alt="..." class="img-thumbnail">
            <ul class="list-group mt-2 rounded-0">
                           <li class="list-group-item mb-1" style="background-color: #f5f5f5;" aria-disabled="true"> <i class="mdi mdi-basket mr-1"></i>  <strong>Project</strong>
                              <span class="badge badge-primary badge-pill float-right">10</span>
                           </li>
                           <li class="list-group-item mb-1" style="background-color: #f5f5f5;"><i class="mdi mdi-email mr-1"></i> <strong> Messages</strong>
                              <span class="badge badge-primary badge-pill float-right">11</span>
                           </li>
                           <li class="list-group-item mb-1" style="background-color: #f5f5f5;"><i class="mdi mdi-account-multiple mr-1"></i> <strong>Friends</strong>
                              <span class="badge badge-primary badge-pill float-right">14</span>
                           </li>
                           <li class="list-group-item" style="background-color: #f5f5f5;"><i class="mdi mdi-autorenew mr-1"></i> <strong>Settings</strong>
                           </li>
                        </ul>
                     </div>
                  </div>
